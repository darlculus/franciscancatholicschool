            ...
            <div class="profile-section">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-item">
                        ...
                        <div>${teacher.assignedClass || 'Not assigned'}</div>
                    </div>
                </div>
            </div>
...
function updateTeacherStats() {
    ...
    // Calculate new teachers (joined in the last 30 days)
    const thirtyDaysAgo = new Date();
    thirtyDaysAgo.setDate(thirtyDaysAgo.getDate() - 30);
    
    const newTeachers = teachers.filter(t => new Date(t.joinDate) >= thirtyDaysAgo).length;
    
    // Update stats
    updateStats(total, active, inactive, newTeachers);
}
...
function showNotification(message, type = 'info') {
    ...
    if (!toast || !toastMessage || !toastIcon) {
        ...
        newToast.className = `notification-toast notification-${type}`;
        
        newToast.innerHTML = `
            <div class="notification-content">
                <i id="notification-icon" class="notification-icon fas ${getNotificationIcon(type)}"></i>
        ...
        newToast.querySelector('.notification-close').addEventListener('click', function() {
        ...
        toastIcon.className = `notification-icon fas ${getNotificationIcon(type)}`;
    ...
    teachers = [
        {
            ...
            status: 'active',
            profileColor: '#4CAF50',
            createdAt: '2018-08-15T10:30:00Z'
        },
        {
            id: 'TCH002',
            firstName: 'Sarah',
            ...
            status: 'active',
            profileColor: '#2196F3',
            createdAt: '2018-12-20T09:15:00Z'
        },
        {
            id: 'TCH003',
            firstName: 'Michael',
            ...
            status: 'active',
            profileColor: '#FF9800',
            createdAt: '2017-05-01T11:45:00Z'
        },
        {
            id: 'TCH004',
            firstName: 'Emily',
            ...
            status: 'active',
            profileColor: '#9C27B0',
            createdAt: '2018-02-25T14:20:00Z'
        },
        {
            id: 'TCH005',
            firstName: 'David',
            ...
            address: '654 Maple Drive, Lagos',
            qualification: 'B.A. in Fine Arts',
            specialization: 'Creative Arts',
            experience: '12',
            joinDate: '2015-08-05',
            assignedClass: 'Primary 2',
            employmentType: 'Full-time',
            username: 'dwilson',
            role: 'Arts Coordinator',
            status: 'active',
            profileColor: '#F44336',
            createdAt: '2015-07-20T08:30:00Z'
        },
        {
            id: 'TCH006',
            firstName: 'Jennifer',
            ...
            address: '987 Cedar Lane, Lagos',
            qualification: 'B.Ed. in Early Childhood Education',
            specialization: 'Nursery Education',
            experience: '4',
            joinDate: '2020-02-15',
        ...
        },
        {
            ...
            address: '159 Birch Street, Lagos',
            ...
            status: 'active',
            profileColor: '#673AB7',
            createdAt: '2017-08-15T09:45:00Z'
        },
        {
            id: 'TCH008',
            firstName: 'Lisa',
            ...
            address: '753 Walnut Avenue, Lagos',
            qualification: 'B.A. in Music',
            specialization: 'Music',
            experience: '8',
            joinDate: '2018-01-10',
            assignedClass: 'Nursery 1',
            employmentType: 'Part-time',
            username: 'lthomas',
            role: 'Music Teacher',
            status: 'active',
            profileColor: '#3F51B5',
            createdAt: '2017-12-20T13:15:00Z'
        },
        {
            id: 'TCH009',
            firstName: 'James',
            ...
            status: 'active',
            profileColor: '#E91E63',
            createdAt: '2012-08-01T08:00:00Z'
        },
        {
            id: 'TCH010',
            firstName: 'Mary',
            ...
            status: 'active',
            profileColor: '#795548',
            createdAt: '2010-06-01T09:30:00Z'
        }
    ];
